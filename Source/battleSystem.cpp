...
/// DEBUG
const vector<GroundPARM> _groundsXY{ GroundPARM(0, 100, 1, 5), GroundPARM(0, 200, 1, 5), GroundPARM(0, 300, 1, 5), GroundPARM(0, 400, 1, 5), GroundPARM(0, 500, 1, 5), GroundPARM(500, 500, 1, 5), GroundPARM(1000, 500, 1, 5), GroundPARM(1000, 400, 1, 5), GroundPARM(1000, 300, 1, 5), GroundPARM(1000, 200, 1, 5), GroundPARM(1000, 100, 1, 5) };    // Define Ground position to automatically generate ground objects
