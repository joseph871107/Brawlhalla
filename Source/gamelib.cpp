...
CAnimation& CAnimation::operator=(const CAnimation& rightObject)
{
    if (this != &rightObject)
    {
        bmp = rightObject.bmp;
        bmp_iter = bmp.begin();
        bmp_counter = rightObject.bmp_counter;
        delay_counter = rightObject.delay_counter;
        delay_count = rightObject.delay_count;
        x = rightObject.x;
        y = rightObject.y;
